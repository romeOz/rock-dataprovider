...
/**
 * BaseDataProvider provides a base class that implements the {@see \rock\data\DataProviderInterface}.
 *
...
abstract class BaseDataProvider implements ObjectInterface, DataProviderInterface
{
     ...
     * {@see \rock\data\BaseDataProvider::getModels()} and {@see \rock\data\BaseDataProvider::getKeys()}.
     *
     * This method will be implicitly called by {@see \rock\data\BaseDataProvider::getModels()} and {@see \rock\data\BaseDataProvider::getKeys()} if it has not been called before.
     *
     ...
     * When {@see \rock\data\PaginationProvider} is false, this returns the same value as {@see \rock\data\BaseDataProvider::count()}.
     * Otherwise, it will call {@see \rock\data\BaseDataProvider::prepareTotalCount()} to get the count.
     ...
     * Note that you should call {@see \rock\data\BaseDataProvider::prepare()} or {@see \rock\data\BaseDataProvider::getModels()} first to get correct values
     * of {@see \rock\data\PaginationProvider::$totalCount} and {@see \rock\data\PaginationProvider::$pageCount}.
     ...
     * After calling this method, if {@see \rock\data\BaseDataProvider::getModels()}, {@see \rock\data\BaseDataProvider::getKeys()} or {@see \rock\data\BaseDataProvider::getTotalCount()} is called again,
