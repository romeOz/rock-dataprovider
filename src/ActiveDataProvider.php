 ...
 *
 * ActiveDataProvider provides data by performing DB queries using {@see \rock\data\ActiveDataProvider::$query}.
 *
...
class ActiveDataProvider extends BaseDataProvider
{
     ...
     *
     * - If {@see \rock\data\ActiveDataProvider::$query} is an  {@see \rock\db\ActiveQuery} instance, the primary keys of {@see \rock\db\ActiveQuery::$modelClass} will be used.
